...
# Matrix Factorization Model Class using torch
...
if __name__ == "__main__":
    ...
    # demo code for outside using
    """
    # from models.collaborative_filter import CollaborativeFilteringMF # if using outside
